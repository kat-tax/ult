 ...
 * Types.ts
 *
 * Type definitions for react-ult-ext-navigator extension.
 */
...
export type NavigationTransitionSpec = {
  ...
  easing?: ULT.Types.Animated.EasingFunction;
};
...
export type CustomNavigatorSceneConfig = {
  ...
  transitionStyle: (sceneIndex: number, sceneDimensions: ULT.Types.Dimensions) => NavigationTransitionStyleConfig;
  // Optional overrides for duration, easing, and timing
  transitionSpec?: NavigationTransitionSpec;
  // Optional cardStyle override
  cardStyle?: ULT.Types.ViewStyleRuleSet;
...
export interface NavigatorProps extends ULT.CommonProps {
  ...
  transitionStarted?: (progress?: ULT.Types.AnimatedValue,
