...
export class NavigatorImpl extends BaseNavigator<NavigatorState> {
  ...
  componentDidMount() {
    ULT.Input.backButtonEvent.subscribe(this._delegate.onBackPress);
  }

  componentWillUnmount() {
    ULT.Input.backButtonEvent.unsubscribe(this._delegate.onBackPress);
  }
