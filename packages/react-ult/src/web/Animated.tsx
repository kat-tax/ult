 ...
 * Animated.tsx
 *
 * Implements animated components for web version of ULT.
 */
...
export let timing: Ult.Types.Animated.TimingFunction = function(
  value: Value, config: Ult.Types.Animated.TimingAnimationConfig): Ult.Types.Animated.CompositeAnimation {
...
export let sequence: Ult.Types.Animated.SequenceFunction = function(
  animations: Array<Ult.Types.Animated.CompositeAnimation>): Ult.Types.Animated.CompositeAnimation {
...
export let parallel: Ult.Types.Animated.ParallelFunction = function(
  animations: Array<Ult.Types.Animated.CompositeAnimation>): Ult.Types.Animated.CompositeAnimation {
...
export let Image = createAnimatedComponent(UltImage) as typeof Ult.AnimatedImage;
export let Text = createAnimatedComponent(UltText) as typeof Ult.AnimatedText;
export let TextInput = createAnimatedComponent(UltTextInput) as typeof Ult.AnimatedTextInput;
export let View = createAnimatedComponent(UltView) as typeof Ult.AnimatedView;
