...
enum ComponentPhaseEnum {
  ...
  // detected a list edit in UNSAFE_componentWillUpdate but hasn't yet gotten the opportunity
...
// Pieces of information we calculate in UNSAFE_componentWillUpdate and consume in componentDidUpdate.
// More specifically, we calculate animation information in UNSAFE_componentWillUpdate and start the
...
export class MonitorListEdits extends React.Component<MonitorListEditsProps, Types.Stateless> {
  ...
  private _childrenKeys!: ChildKey[]; // Updated in UNSAFE_componentWillUpdate
  private _childrenMap!: ChildrenMap; // Updated in UNSAFE_componentWillUpdate
  ...
  UNSAFE_componentWillUpdate(nextProps: MonitorListEditsProps) {
    assert(
      ...
      'UNSAFE_componentWillUpdate should never run while the component is animating'
    );
