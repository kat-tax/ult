...
if (typeof document !== 'undefined') {
  const ignorePointerEvents = '.ult-ignore-pointer-events  * {pointer-events: auto}';
  const blockPointerEvents = '.ult-block-pointer-events * { pointer-events: none !important; }';
...
export class View extends ViewBase<Ult.Types.ViewProps, Ult.Types.Stateless, Ult.View> {
  ...
  render() {
    ...
    const props: React.HTMLAttributes<any> = {
      ...
      // Weird things happen: ULT.Types.Touch is not assignable to React.Touch
    ...
    if (this.props.blockPointerEvents) {
      ...
      props.className = 'ult-block-pointer-events';
      ...
      props.className = 'ult-ignore-pointer-events';
      combinedStyles.pointerEvents = 'none';
    }
    ...
    return this.context.isUltParentAText ? restyleForInlineText(reactElement) : reactElement;
  }
