...
const timing = function(
  ...
  config: Ult.Types.Animated.TimingAnimationConfig
) : Ult.Types.Animated.CompositeAnimation {
...
export let AnimatedCommon = {
  ...
  interpolate: (animatedValue: Ult.Types.AnimatedValue, inputRange: number[], outputRange: string[]) => {
