...
class ModalStackContext {
  constructor(
    ...
    public modal: React.ReactElement<Types.ViewProps>,
    public modalOptions?: Types.ModalOptions
  ) {}
}
...
class PopupStackContext {
  constructor(
    ...
    public popupOptions: Types.PopupOptions,
    public anchorHandle: number
  ) {}
}
...
export class FrontLayerViewManager {
  ...
  getModalLayerView(rootViewId?: string | null): React.ReactElement<any> | null {
    ...
    const overlayContext =
      _.findLast(
        this._overlayStack,
        context => context instanceof ModalStackContext
          && this._modalOptionsMatchesRootViewId(context.modalOptions, rootViewId)
        ...
        RN.NativeModules.UIManager.measureInWindow(
          ...
          (x: number, y: number, width: number, height: number) => {
            ...
            if (!_.isUndefined(touchEvent.pageX) && !_.isUndefined(touchEvent.pageY) &&
              ...
              Timers.setTimeout(() => {
                activePopupContext.popupOptions.onAnchorPressed!(e);
              }, 500);
            }
          }
        );
