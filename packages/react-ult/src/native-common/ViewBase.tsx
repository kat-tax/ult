...
export abstract class ViewBase<P extends Ult.Types.ViewPropsShared<C>, S, T extends RN.View | RN.ScrollView,
    C extends Ult.View | Ult.ScrollView> extends Ult.ViewBase<P, S> {
