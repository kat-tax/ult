...
export class Styles extends Ult.Styles {
  combine<S>(ruleSet1: Ult.Types.StyleRuleSetRecursive<S> | undefined, ruleSet2?: Ult.Types.StyleRuleSetRecursive<S>)
      : Ult.Types.StyleRuleSetOrArray<S> | undefined {
  ...
  private _adaptStyles<S extends Ult.Types.ViewAndImageCommonStyle>(
    def: S,
    cacheStyle: boolean,
    isTextStyle = false
  ): Readonly<Ult.Types.StyleRuleSet<S>> {
