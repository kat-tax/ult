...
class RootViewUsingStore extends BaseRootView<BaseRootViewProps> {
    ...
    protected _getPropsForMainView(): {} {
        const { ult_rootViewId, ...mainViewProps } = this.props;
...
class RootViewUsingProps extends BaseRootView<RootViewPropsWithMainViewType> {
    constructor(props: RootViewPropsWithMainViewType) {
        ...
        if (!props.ult_rootViewId) {
            if (AppConfig.isDevelopmentMode()) {
                console.warn('Some APIs require a value for ult_rootViewId');
            }
            this._rootViewId = null;
        } else {
            this._rootViewId = props.ult_rootViewId;
        }

        this.state = {
            mainView: React.createElement(props.ult_mainViewType, this._mainViewProps),
            announcementText: '',
        };
    }

    protected _getPropsForMainView(): {} {
        const { ult_mainViewType, ult_rootViewId, ...mainViewProps } = this.props;
        return mainViewProps;
    }
}
