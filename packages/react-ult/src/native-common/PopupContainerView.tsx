...
import {
  PopupContainerViewBase,
  PopupContainerViewBaseProps,
  PopupContainerViewContext,
  recalcPositionFromLayoutData,
  RecalcResult
} from '../common/PopupContainerViewBase';
...
export class PopupContainerView extends PopupContainerViewBase<PopupContainerViewProps, PopupContainerViewState, PopupContainerView> {
  ...
  private _recalcPositionFromLayoutData(anchorRect: ClientRect, popupRect: ClientRect): void {
    ...
    const result = recalcPositionFromLayoutData(
      windowDims,
      anchorRect,
      popupRect,
      this.props.popupOptions.positionPriorities,
