...
* Types.ts
*
* Type definitions for ULT framework.
*/

import * as React from 'react';

import * as Ult from './Interfaces'; // use only for type data
...
export interface ScrollViewProps extends CommonStyledProps<ScrollViewStyleRuleSet, Ult.ScrollView>, CommonAccessibilityProps {
  ...
  // Animation helpers to allow usage of the RN.Animated.Event system through ULT.
