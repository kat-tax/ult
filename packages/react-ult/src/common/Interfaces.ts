 ...
 * Interfaces.ts
 *
 * Defines the template for the ULT interface that needs to be
...
export abstract class Styles {
    ...
    // This method isn't part of the documented ULT interface and shouldn't be used by
    // app-level code, but it is needed for some ULT extensions (e.g. react-ult-ext-svg),
